export const collections = [
  ...
  },
  {
    ...
    subFolder: 'deer-park',
    featuredImage: {
      name: 'embracing-a-colourful-world',
  ...
  },
  {
    ...
    subFolder: 'coast',
    featuredImage: {
      name: 'west-bay-beach-and-harbour',
      altText: 'Coast'
    },
    desc: [
      'The coastal landscape of Dorset has provided a meaningful and enduring source of inspiration for my work. I have been particularly drawn to West Bay with its iconic sandstone cliffs and lively colourful harbour. Personally, it will always be a special place for me as it holds memories of walking along the shoreline with my beloved dog Darwin.'
    ],
    imagesData: {
      subFolder: 'coast',
      images: [
  ...
  },
  {
    ...
    desc: [
      "Artworks made specifically for an exhibition with the Brunel Broderers on the theme 'Strand' at Bridport Art Centre. These thread drawings started out as sketches depicting my faithful hound Darwin playing on the beach and are combined with observations of the shoreline, cliffs and sea at West Bay and Eype. The borders of the embroideries reference the shapes formed by the constant rolling swell of the sea breaking over the pebbled beach. Intermingling seaweeds of many species lend themselves perfectly to this mix of seaside imagery."
    ],
    imagesData: {
      subFolder: 'strand',
      images: [
